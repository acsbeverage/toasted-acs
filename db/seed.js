    ...
    try {
      ...
      await query(`
        ...
        ON CONFLICT (sku) DO UPDATE SET
          name=$2,stock=$6,
          price_frontline=$8,price_mix12=$9,price_acs3=$10,
          price_brand3=$11,price_brand5=$12,
          da_frontline=$13,da_mix12=$14,da_acs3=$15,
          da_brand3=$16,da_brand5=$17,
          redemption_entry=$18,active=$19,core=$20
      `, [sku,name,producer,cat,btl,stock,reorder,
          fl,m12,a3,b3,b5,daFl,daM12,daA3,daB3,daB5,
          redemption,active,core]);
      count++;
...
async function seedAccounts(html) {
  ...
  for (const line of lines) {
    try {
      ...
      await query(`
        INSERT INTO accounts (id,name,code,lic,abc_num,contact,
...
async function seed() {
  ...
  await seedUsers(html);
  await seedProducts(html);
  await seedAccounts(html);
